...
# ---------------------------------------------------------------------------
# Sidebar -- redesigned as a clean left rail: brand + account status at the
# top (always visible), the step list as the main focus, and everything
# secondary (billing, saved projects, AI provider config, file import/export)
# tucked behind a single "More" popover so it doesn't compete for attention.
# ---------------------------------------------------------------------------
